...
public class ProyectoService {
    ...
    public ResponseEntity<AppiResponse> findMisProyectos(String username) {
        ...
        return ResponseEntity.ok(
                new AppiResponse("Operación exitosa", data, HttpStatus.OK)
        );
    }
    ...
    public ResponseEntity<AppiResponse> save(Proyecto proyecto) {
        ...
        if (proyectoRepository.existsByNombre(proyecto.getNombre().trim())) {
            return ResponseEntity.badRequest()
        ...
        nuevoProyecto.setNombre(proyecto.getNombre().trim());
        nuevoProyecto.setDescripcion(proyecto.getDescripcion());
        nuevoProyecto.setObjetivo(proyecto.getObjetivo());
        nuevoProyecto.setFechaInicio(
                proyecto.getFechaInicio() != null ? proyecto.getFechaInicio() : LocalDate.now()
        );
        nuevoProyecto.setFechaFin(proyecto.getFechaFin());
        nuevoProyecto.setPresupuestoTotal(proyecto.getPresupuestoTotal());
        nuevoProyecto.setLogo(proyecto.getLogo());
        ...
        nuevoProyecto.setEquipo(null);
        nuevoProyecto.setLider(null);
